...
import styles from './Banner_3.module.scss'
		...
		<div className={styles.root}>
			<div className={styles.left}>
				<div className={styles.header}>
					<span>
						/ Гарантируем моментальную оплату <br /> после закрытия смены
					</span>
					<h3>
						Большой выбор простых <br />
						и удобных подработок <br />в твоем городе
					</h3>
					<span />
				</div>
